 ...
 */
UCLASS()
class TEAMPROJ_API USmallShop : public UUserWidget
{
	GENERATED_BODY()

public:
	USmallShop(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	UFUNCTION(BlueprintCallable)
	void SetupShop(UShopComponent* ShopComponent, UItemComponent* ItemComponent);
	...
	UFUNCTION(BlueprintCallable, Category = "Small Shop")
