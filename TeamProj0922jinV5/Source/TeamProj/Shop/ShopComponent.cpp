...
void UShopComponent::InitAllShopItems()
{
    ...
    if (m_PlayerItemComponent)
    {
        ...
        UE_LOG(LogTemp, Log, TEXT("ShopComponent: Using player ItemComponent data for refresh (%d items)"), ShopItems.Num());
    }
    else
    {
        ...
        UE_LOG(LogTemp, Log, TEXT("ShopComponent: Using DataTable data for refresh (%d items)"), ShopItems.Num());
    }
...
void UShopComponent::SyncShopItemData(FName ItemID, const FItemData& NewItemData)
{
    ...
    if (ShopItem)
    {
        ...
        UE_LOG(LogTemp, Log, TEXT("ShopComponent: Shop item data synced for %s"), *ItemID.ToString());
    }
}
...
void UShopComponent::SetPlayerItemComponent(UItemComponent* ItemComponent)
{
    ...
    UE_LOG(LogTemp, Log, TEXT("ShopComponent: Player ItemComponent set"));
}
