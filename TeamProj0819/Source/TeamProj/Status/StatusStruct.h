...
{   //Common Weapon
    ...
    Katana           UMETA(DistplayName = "Katana"),
    Hammer           UMETA(DistplayName = "Hammer"),
    Spear            UMETA(DistplayName = "Spear"),
    Staff            UMETA(DistplayName = "Staff"),
    Throwing         UMETA(DistplayName = "Throwing"),
    Gun              UMETA(DistplayName = "Gun"),
...
struct FStatModifier
{
    ...
    {
        return
            FMath::IsNearlyEqual(AddHP, Other.AddHP) &&
            FMath::IsNearlyEqual(AddAtk, Other.AddAtk) &&
            FMath::IsNearlyEqual(AddDef, Other.AddDef) &&
            FMath::IsNearlyEqual(AddAtkSpd, Other.AddAtkSpd) &&
            FMath::IsNearlyEqual(AddCritR, Other.AddCritR) &&
            FMath::IsNearlyEqual(AddCritD, Other.AddCritD) &&
            FMath::IsNearlyEqual(AddAtkRadius, Other.AddAtkRadius) &&
            FMath::IsNearlyEqual(AddCoolRec, Other.AddCoolRec) &&
            FMath::IsNearlyEqual(AddSpd, Other.AddSpd);
    }
};
